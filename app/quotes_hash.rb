...
$errors = {
    ...
    4 => "Why do we fall sir? So that we can leaen to pick ourselves up",
    5 => "Why so serious?!",
    6 => "Fasten your seatbelts. Its going to be a bumpy night.",
    7 => "You're gonna need a bigger boat",
    8 => "Houston, we have a problem",
    9 => "I'm going to have to science the shit out of this",
    10 => "I am Groot",
